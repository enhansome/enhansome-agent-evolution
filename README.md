...
* [**Eliza**](https://github.com/elizaOS/eliza) ⭐ 19,096 | 🐛 356 | 🌐 TypeScript | 📅 2026-08-19 - Autonomous agents for everyone. A framework for creating and deploying AI agents that evolve over time. by [@elizaOS](https://github.com/elizaOS) (19,092 stars)
* [**Agent Zero**](https://github.com/agent0ai/agent-zero) ⭐ 18,911 | 🐛 156 | 🌐 Python | 📅 2026-08-19 - General-purpose AI agent framework that learns and evolves through interaction. by [@agent0ai](https://github.com/agent0ai) (18,906 stars)
...
* [**evolver**](https://github.com/EvoMap/evolver) ⭐ 8,984 | 🐛 16 | 🌐 JavaScript | 📅 2026-08-17 - The GEP-powered self-evolution engine for AI agents. Genome Evolution Protocol enables agents to evolve autonomously via mutation and selection. by [@EvoMap](https://github.com/EvoMap) (8,979 stars)
...
* [**Ouroboros**](https://github.com/razzant/ouroboros) ⭐ 1,193 | 🐛 95 | 🌐 Python | 📅 2026-08-19 - Self-creating AI agent that writes its own code and evolves autonomously. Completed 30+ evolution cycles in first 24 hours with zero human intervention. by [@razzant](https://github.com/razzant) (1,187 stars)
* [**A-Evolve**](https://github.com/A-EVO-Lab/a-evolve) ⭐ 734 | 🐛 7 | 🌐 Python | 📅 2026-08-18 - The PyTorch for Agentic AI. Open-source infrastructure that evolves any agent across any domain with zero human intervention. #1 on MCP-Atlas (79.4%). by [@A-EVO-Lab](https://github.com/A-EVO-Lab) (730 stars)
...
* [**Mem0**](https://github.com/mem0ai/mem0) ⭐ 63,601 | 🐛 690 | 🌐 Python | 📅 2026-08-18 - Production-ready AI agent memory with scalable long-term memory. 26% improvement over baseline on LOCOMO benchmark with 91% latency reduction. by [@mem0ai](https://github.com/mem0ai) (63,564 stars)
* [**Cognee**](https://github.com/topoteretes/cognee) ⭐ 30,115 | 🐛 356 | 🌐 Python | 📅 2026-08-19 - Knowledge engine for AI agent memory. Build and query knowledge graphs from unstructured data in 6 lines of code. by [@topoteretes](https://github.com/topoteretes) (30,114 stars)
* [**agentmemory**](https://github.com/rohitg00/agentmemory) ⭐ 27,179 | 🐛 478 | 🌐 TypeScript | 📅 2026-08-17 - Persistent, benchmark-tuned memory for coding agents (Claude Code, Cursor, Copilot CLI, Codex, and any MCP client). Remembers context across sessions so you stop re-explaining. by [@rohitg00](https://github.com/rohitg00) (27,165 stars)
* [**Letta**](https://github.com/letta-ai/letta) ⭐ 24,300 | 🐛 41 | 📅 2026-08-16 - Platform for building stateful agents with advanced self-editing memory. Formerly MemGPT. by [@letta-ai](https://github.com/letta-ai) (24,299 stars)
* [**TencentDB Agent Memory**](https://github.com/TencentCloud/TencentDB-Agent-Memory) ⭐ 23,178 | 🐛 635 | 🌐 TypeScript | 📅 2026-08-15 - Fully local long-term memory for AI agents via a four-tier progressive storage architecture, from Tencent Cloud. by [@TencentCloud](https://github.com/TencentCloud) (23,060 stars)
...
* [**EverMemOS**](https://github.com/EverMind-AI/EverOS) ⭐ 12,197 | 🐛 73 | 🌐 Python | 📅 2026-08-17 - Long-term memory for 24/7 AI agents across LLMs and platforms. by [@EverMind-AI](https://github.com/EverMind-AI) (12,171 stars)
* [**holaOS**](https://github.com/holaboss-ai/holaOS) ⭐ 10,068 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-19 - Agent environment for long-horizon work, continuity, and self-evolution. by [@holaboss-ai](https://github.com/holaboss-ai) (9,954 stars)
...
* [**honcho**](https://github.com/plastic-labs/honcho) ⭐ 6,723 | 🐛 157 | 🌐 Python | 📅 2026-08-19 - Memory library for building stateful agents with user context management. by [@plastic-labs](https://github.com/plastic-labs) (6,718 stars)
* [**memgraph**](https://github.com/memgraph/memgraph) ⭐ 4,347 | 🐛 792 | 🌐 C++ | 📅 2026-08-19 - High-performance open-source in-memory graph database for GraphRAG, AI memory, agentic AI, and real-time graph analytics. Cypher-compatible, built in C++. by [@memgraph](https://github.com/memgraph) (4,347 stars)
...
* [**MemMachine**](https://github.com/MemMachine/MemMachine) ⭐ 3,184 | 🐛 91 | 🌐 Python | 📅 2026-08-17 - Universal memory layer for AI agents. Episodic (graph-based), profile (SQL), and working memory with scalable storage and retrieval. by [@MemMachine](https://github.com/MemMachine) (3,178 stars)
...
* [**Mem9**](https://github.com/mem9-ai/mem9) ⭐ 1,189 | 🐛 89 | 🌐 TypeScript | 📅 2026-08-19 - Unlimited persistent memory layer for AI agents. Cloud-synced memory across sessions and tools. by [@mem9-ai](https://github.com/mem9-ai) (1,187 stars)
...
* [**Google A2A**](https://github.com/a2aproject/A2A) ⭐ 25,416 | 🐛 234 | 🌐 Shell | 📅 2026-08-18 - Google's open Agent-to-Agent protocol. Enables agent discovery, secure collaboration, and long-running tasks while preserving agent opacity. by [@a2aproject](https://github.com/a2aproject) (25,403 stars)
* [**mcp-use**](https://github.com/mcp-use/mcp-use) ⭐ 10,504 | 🐛 86 | 🌐 TypeScript | 📅 2026-08-18 - The fullstack MCP framework to develop MCP Apps for ChatGPT/Claude and MCP Servers for AI Agents. by [@mcp-use](https://github.com/mcp-use) (10,502 stars)
...
* [**dify**](https://github.com/langgenius/dify) ⭐ 152,902 | 🐛 991 | 🌐 TypeScript | 📅 2026-08-19 - Production-ready platform for building agentic AI workflows with visual orchestration. by [@langgenius](https://github.com/langgenius) (152,867 stars)
* [**LangChain**](https://github.com/langchain-ai/langchain) ⭐ 144,565 | 🐛 409 | 🌐 Python | 📅 2026-08-19 - Full-stack agent engineering platform with composable chains, tools, and memory integration. by [@langchain-ai](https://github.com/langchain-ai) (144,519 stars)
* [**OpenHands**](https://github.com/OpenHands/OpenHands) ⭐ 84,477 | 🐛 487 | 🌐 TypeScript | 📅 2026-08-19 - Open platform for AI software developers as generalist agents. Autonomous coding, debugging, and deployment. by [@OpenHands](https://github.com/OpenHands) (84,445 stars)
* [**CowAgent**](https://github.com/zhayujie/CowAgent) ⭐ 46,568 | 🐛 36 | 🌐 Python | 📅 2026-08-19 - Super AI assistant based on LLMs with autonomous thinking, task planning, skill creation, and long-term memory. by [@zhayujie](https://github.com/zhayujie) (46,560 stars)
* [**agno**](https://github.com/agno-agi/agno) ⭐ 41,781 | 🐛 1,263 | 🌐 Python | 📅 2026-08-19 - Production-ready agent framework that turns agents into deployable services with multi-framework support. by [@agno-agi](https://github.com/agno-agi) (41,772 stars)
* [**langgraph**](https://github.com/langchain-ai/langgraph) ⭐ 40,019 | 🐛 701 | 🌐 Python | 📅 2026-08-19 - Build resilient language agents as stateful graphs with persistence and streaming. by [@langchain-ai](https://github.com/langchain-ai) (39,987 stars)
* [**CoPaw**](https://github.com/agentscope-ai/QwenPaw) ⭐ 34,071 | 🐛 914 | 🌐 Python | 📅 2026-08-19 - Co Personal Agent Workstation built on AgentScope. Desktop agent platform with multi-agent collaboration and tool integration. by [@agentscope-ai](https://github.com/agentscope-ai) (34,020 stars)
* [**mastra**](https://github.com/mastra-ai/mastra) ⭐ 27,304 | 🐛 442 | 🌐 TypeScript | 📅 2026-08-19 - TypeScript framework for building AI-powered applications with agent workflows and RAG. by [@mastra-ai](https://github.com/mastra-ai) (27,291 stars)
* [**AgenticSeek**](https://github.com/Fosowl/agenticSeek) ⭐ 26,903 | 🐛 36 | 🌐 Python | 📅 2026-08-11 - Fully local autonomous agent with browsing, coding, and multi-agent capabilities. No API keys required. by [@Fosowl](https://github.com/Fosowl) (26,902 stars)
* [**haystack**](https://github.com/deepset-ai/haystack) ⭐ 26,253 | 🐛 101 | 🌐 Python | 📅 2026-08-19 - Open-source AI orchestration framework for building context-engineered production applications. by [@deepset-ai](https://github.com/deepset-ai) (26,250 stars)
...
* [**Google ADK**](https://github.com/google/adk-python) ⭐ 21,191 | 🐛 563 | 🌐 Python | 📅 2026-08-19 - Open-source Python toolkit by Google for building, evaluating, and deploying sophisticated AI agents. by [@google](https://github.com/google) (21,180 stars)
* [**PydanticAI**](https://github.com/pydantic/pydantic-ai) ⭐ 19,390 | 🐛 721 | 🌐 Python | 📅 2026-08-19 - Type-safe AI agent framework built on Pydantic with structured outputs and dependency injection. by [@pydantic](https://github.com/pydantic) (19,379 stars)
...
* [**OpenFang**](https://github.com/RightNow-AI/openfang) ⭐ 18,123 | 🐛 115 | 🌐 Rust | 📅 2026-07-02 - Open-source Agent Operating System for deploying and managing AI agents. by [@RightNow-AI](https://github.com/RightNow-AI) (18,121 stars)
* [**agents**](https://github.com/livekit/agents) ⭐ 13,082 | 🐛 772 | 🌐 Python | 📅 2026-08-19 - Framework for building realtime voice AI agents with speech-to-speech pipelines. by [@livekit](https://github.com/livekit) (13,072 stars)
...
* [**MS-Agent**](https://github.com/modelscope/ms-agent) ⭐ 4,367 | 🐛 27 | 🌐 Python | 📅 2026-08-17 - Lightweight framework by ModelScope to empower agentic execution of complex tasks with memory and deep research. by [@modelscope](https://github.com/modelscope) (4,365 stars)
...
* [**Claude Code**](https://github.com/anthropics/claude-code) ⭐ 141,991 | 🐛 15,146 | 🌐 Python | 📅 2026-08-18 - Terminal-native agentic coding tool from Anthropic. Understands your codebase and executes tasks through natural language. by [@anthropics](https://github.com/anthropics) (141,928 stars)
* [**Codex**](https://github.com/openai/codex) ⭐ 106,818 | 🐛 13,145 | 🌐 Rust | 📅 2026-08-19 - Lightweight coding agent from OpenAI written in Rust. Runs locally as CLI, IDE extension, or desktop app. by [@OpenAI](https://github.com/OpenAI) (106,733 stars)
* [**Pi**](https://github.com/earendil-works/pi) ⭐ 93,663 | 🐛 135 | 🌐 TypeScript | 📅 2026-08-19 - Self-extensible coding agent and agent harness. Bundles an interactive coding CLI, an agent runtime with tool calling and state, and a unified multi-provider LLM API. by [@earendil-works](https://github.com/earendil-works) (93,364 stars)
* [**agent-skills**](https://github.com/addyosmani/agent-skills) ⭐ 88,536 | 🐛 109 | 🌐 JavaScript | 📅 2026-08-14 - Production-grade engineering skills and best practices for AI coding agents. by [@addyosmani](https://github.com/addyosmani) (88,448 stars)
* [**Taste-Skill**](https://github.com/Leonxlnx/taste-skill) ⭐ 78,066 | 🐛 56 | 🌐 JavaScript | 📅 2026-08-17 - High-Agency frontend skill that helps AI generate less generic, more tasteful outputs. by [@Leonxlnx](https://github.com/Leonxlnx) (77,872 stars)
* [**Cline**](https://github.com/cline/cline) ⭐ 66,472 | 🐛 1,045 | 🌐 TypeScript | 📅 2026-08-19 - Autonomous coding agent available as an IDE extension, CLI, or SDK. Plans and executes multi-step edits with human-in-the-loop approval. by [@cline](https://github.com/cline) (66,447 stars)
* [**goose**](https://github.com/aaif-goose/goose) ⭐ 52,991 | 🐛 316 | 🌐 Rust | 📅 2026-08-19 - Open-source extensible AI coding agent that goes beyond code suggestions. by [@aaif-goose](https://github.com/aaif-goose) (52,974 stars)
* [**Aider**](https://github.com/Aider-AI/aider) ⭐ 48,324 | 🐛 1,818 | 🌐 Python | 📅 2026-05-22 - AI pair programming in your terminal. Edit code with LLMs across 100+ languages with deep Git integration. by [@Aider-AI](https://github.com/Aider-AI) (48,321 stars)
* [**Qwen Code**](https://github.com/QwenLM/qwen-code) ⭐ 27,190 | 🐛 1,092 | 🌐 TypeScript | 📅 2026-08-19 - Open-source AI coding agent that lives in your terminal, optimized for Qwen-Coder models. by [@QwenLM](https://github.com/QwenLM) (27,176 stars)
...
* [**context-mode**](https://github.com/mksglu/context-mode) ⭐ 19,978 | 🐛 161 | 🌐 TypeScript | 📅 2026-08-19 - Context window optimization tool for AI coding agents with sandboxed tool output and 98% token reduction. by [@mksglu](https://github.com/mksglu) (19,970 stars)
...
* [**Open SWE**](https://github.com/langchain-ai/open-swe) ⭐ 10,577 | 🐛 30 | 🌐 Python | 📅 2026-08-19 - Open-source asynchronous coding agent by LangChain for software engineering tasks. by [@langchain-ai](https://github.com/langchain-ai) (10,575 stars)
* [**Mini-SWE-Agent**](https://github.com/SWE-agent/mini-swe-agent) ⭐ 6,611 | 🐛 48 | 🌐 Python | 📅 2026-08-17 - The 100-line AI agent that solves GitHub issues. Radically simple but scores >74% on SWE-bench verified. by [@SWE-agent](https://github.com/SWE-agent) (6,601 stars)
...
* [**Promptfoo**](https://github.com/promptfoo/promptfoo) ⭐ 24,376 | 🐛 509 | 🌐 TypeScript | 📅 2026-08-19 - Open-source LLM evaluation and red-teaming framework. Test prompts, agents, and RAGs with 90+ model providers and 67+ security plugins. by [@promptfoo](https://github.com/promptfoo) (24,357 stars)
...
* [**NeMo Guardrails**](https://github.com/NVIDIA-NeMo/Guardrails) ⭐ 6,973 | 🐛 223 | 🌐 Python | 📅 2026-08-19 - NVIDIA's toolkit for adding programmable guardrails to LLM conversational systems. Policy-based safety controls. by [@NVIDIA-NeMo](https://github.com/NVIDIA-NeMo) (6,970 stars)
...
* [**LeRobot**](https://github.com/huggingface/lerobot) ⭐ 26,757 | 🐛 805 | 🌐 Python | 📅 2026-08-19 - Open-source robotics framework by Hugging Face. Models, datasets, and tools for real-world robotics in PyTorch. (26,745 stars)
* [**Open-AutoGLM**](https://github.com/zai-org/Open-AutoGLM) ⭐ 26,044 | 🐛 262 | 🌐 Python | 📅 2026-03-06 - An Open Phone Agent Model and Framework. Unlocking the AI Phone for Everyone. by [@zai-org](https://github.com/zai-org) (26,041 stars)
...
* [**Mobile MCP**](https://github.com/mobile-next/mobile-mcp) ⭐ 5,955 | 🐛 58 | 🌐 TypeScript | 📅 2026-08-18 - Model Context Protocol Server for Mobile Automation and Scraping (iOS, Android, Emulators and Real Devices). by [@mobile-next](https://github.com/mobile-next) (5,952 stars)
* [**agent-device**](https://github.com/callstack/agent-device) ⭐ 4,135 | 🐛 70 | 🌐 TypeScript | 📅 2026-08-19 - CLI that lets AI agents drive real iOS and Android devices — taps, text input, screenshots, and app control for mobile automation. by [@callstack](https://github.com/callstack) (4,130 stars)
...
* [SWE-bench](https://github.com/princeton-nlp/SWE-bench) ⭐ 5,668 | 🐛 8 | 🌐 Python | 📅 2026-08-18 (ICLR'24) - Can agents resolve real-world GitHub issues?
